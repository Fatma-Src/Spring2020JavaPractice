...
public class OnlineBookMerchants_80 {
    public static void main(String[] args) {
        ...
        /*
        Online Book Merchants offers premium customers 1 free book with
         every purchase of 5 or more books and offers 2 free books with
         every purchase of 8 or more books. It offers regular customers
         ...
         on the values of the boolean variable isPremiumCustomer
       ...
       if(isPremiumCustomer) {
           ...
           if (nbooksPurchased > 6 && nbooksPurchased < 12) {
               freeBooks = 1;
