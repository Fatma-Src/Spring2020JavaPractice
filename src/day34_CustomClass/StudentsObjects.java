...
public class StudentsObjects {
    public static void main(String[] args) {
        ...
        student1.getStudentInfo("Adam","England",34,3.5,'M',true);

        Student student2=new Student();
        student2.getStudentInfo("Mike","German",30,3.0,'M',false);

        Student student3=new Student();
        student3.getStudentInfo("Johnny Guitar", "US",40,2,'M',false);


        Student student4=new Student();
        student4.getStudentInfo("Anna","Ukrainian", 33,3.9, 'F', true);

        Student[] students={student1,student2,student3,student4};

        ArrayList<Student>canGraduate = new ArrayList(Arrays.asList(students));//we put all students in it to use remove method
